          ...
          {TESTIMONIALS.map((test, idx) => (
            ...
            >
              ...
              <div>
                ...
                <div className="flex gap-1 mb-5" id={`stars-rating-${idx}`}>
                  {[...Array(test.rating)].map((_, i) => (
                    <Star key={i} className="h-4.5 w-4.5 fill-[#35AFA3] text-[#35AFA3]" />
                  ))}
                </div>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-[#1F2937]/10 mt-auto">
                <div className="w-10 h-10 rounded-full bg-[#1F2937] text-[#25A69A] flex items-center justify-center font-display font-black text-sm shadow-sm">
