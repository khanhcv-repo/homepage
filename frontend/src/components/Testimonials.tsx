          ...
          {TESTIMONIALS.map((test, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-[#1F2937]/10 mt-auto">
                <div className="w-10 h-10 rounded-full bg-white text-[#25A69A] flex items-center justify-center font-display font-black text-sm shadow-sm border border-[#25A69A]/10">
